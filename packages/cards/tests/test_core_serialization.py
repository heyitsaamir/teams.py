        ...
        body=[
            ...
            ActionSet(
                actions=[
                    ...
                    .with_data(SubmitActionData(msteams={"action": "submit_basic"}))
...
def test_action_set_serialization():
    ...
    action_set = ActionSet(
        actions=[
            ExecuteAction(title="Execute").with_data(SubmitActionData(msteams={"action": "execute"})),
            SubmitAction(title="Submit").with_data(SubmitActionData(msteams={"action": "submit"})),
        ]
    )
...
def test_msteams_serializes_correctly():
...
def test_submit_action_data_msteams_serialization():
    """Test that SubmitActionData.msteams serializes to 'msteams' correctly."""
    # Create SubmitActionData with custom fields and msteams
